...
internal static class Program
{
    private static void Main(string[] args)
    {
        ...
        string hotKeyConfigPath  = Path.Combine(baseDir, "config/hotkeys.json");
        string taskRegistryPath  = Path.Combine(baseDir, "config/task_registry.csv");
        string packageStorePath  = Path.Combine(baseDir, "config/packages.json");
        ...
        IViewFactory viewFactory = new ViewFactory(hotKeyConfig, hotKeyConfigStore, csvTaskStore, jsonPackageStore);
